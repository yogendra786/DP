...
def helloCallBack1(word):
            ...
            subprocess.call('espeak -ven+f4 -s180 '+word,shell=True)
            sa=word
            s=s+sa
            k=word
            hello1(k)
...
top.config(background="RosyBrown3")
top.option_add("*Background", "RosyBrown3")

L1 = Label(top, text="EYE BLINK WRITER",fg="black")
L1.grid(columnspan=20)
E1 = ScrolledText(top,relief="solid",bg="white",height=11, bd =4,width=110)
...
read=Tkinter.Button(top,text="READ",width="24",command= lambda:say())
...
song4=Tkinter.Button(top,text="TAKE",width="10",command= lambda:myfileOpen())
song4.grid(row=10,column=7)
song5=Tkinter.Button(top,text="SONG",width="10",command= lambda:song())
song5.grid(row=10,column=8)
#E2.grid(columnspan=10)
def song():
    #os.system("mplayer -endpos 352 4.mp3")
    print "Dhiwar"
lo=True;
def stop(a):
    global lo
...
def blink(i, j):
    ...
    if lo :
        ...
        top.after(2300, blink, (i+1) % 7, j+1)
    else:
        flag=i
        flag1=1
        lo=True
        white1(i);
        if i==2:
            top.after(2300, blink2, 0, 0)
        if i==3:
            top.after(2300,blink3,0,0)
        if i==4:
            top.after(2300,blink4,0,0)
        if i==5:
            top.after(2300,blink5,0,0)
        if i==6:
            top.after(2300,blink6,0,0)
        if i==0:
            top.after(2300,blink7,0,0)

        if i==1:
            top.after(2300, blink1, 0, 0)
...
def blink1(i1, j1):
    ...
    global lo1
    if lo1 :
        top.after(2300, blink1, (i1+1) % 4, j1+1)
    else:
    	flag1=0
        white2(i1)
        lo1=True
    ...
    if i1 == 0:
        ...
        alarm.config(fg="black",bg=top["bg"])
...
def blink2(i2, j2):
    ...
    global flag1
    if lo2 :
        top.after(2300, blink2, (i2+1) % 4, j2+1)
    else:
    	flag1=0
        white3(i2)
        lo2=True
...
def blink3(i3, j3):
    ...
    global flag1
    if lo3 :
        top.after(2300, blink3, (i3+1) % 8, j3+1)
    else:
    	flag1=0
        white4(i3)
        lo3=True
...
def blink4(i4, j4):
    ...
    global flag1
    if lo4 :
        top.after(2300, blink4, (i4+1) % 8, j4+1)
    else:
    	flag1=0
        white5(i4)
        lo4=True
...
def blink5(i5, j5):
    ...
    global flag1
    if lo5 :
        top.after(2300, blink5, (i5+1) % 8, j5+1)
    else:
    	flag1=0
        white6(i5)
        lo5=True
...
def blink6(i6, j6):
    ...
    global flag1
    if lo6 :
        top.after(2300, blink6, (i6+1) % 8, j6+1)
    else:
    	flag1=0
        white7(i6)
        lo6=True
...
def blink7(i7, j7):
    ...
    global flag1
    if lo7 :
        top.after(2300, blink7, (i7+1) % 8, j7+1)
    else:
    	flag1=0
        white8(i7)
        lo7=True
